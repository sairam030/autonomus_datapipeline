...
def ingest_bronze(**ctx):
    ...
    config = {'csv_header': True, 'csv_encoding': 'utf-8', 'csv_delimiter': ',', 'file_path': '/data/pipeline/5e80657f-83ed-411b-a851-90331dc5f747', 'file_format': 'csv'}
    pipeline_id = "5e80657f-83ed-411b-a851-90331dc5f747"
    source_type = "csv"
